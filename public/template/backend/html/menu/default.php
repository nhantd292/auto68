...
<!--                    <li>-->
<!--                        <a href="--><?php //echo $this->url('routeAdminDocument/default', array('slug' => 'product-group', 'action' => 'index'));?><!--" target="_self">-->
<!--                            <i class="fa fa-sitemap"></i> <span class="title">Nhóm sản phẩm</span><span class="arrow"></span>-->
<!--                        </a>-->
<!--                    </li>-->
                </ul>
            </li>
            ...
            <li>
                <a href="<?php echo $this->url('routeAdmin/default', array('controller' => 'marketing-target', 'action' => 'index'));?>" target="_self">
                    <i class="fa fa-hourglass-half"></i> <span class="title">Chỉ tiêu Marketing</span><span class="arrow"></span>
                </a>
            </li>
        </ul>
    </li>
	...
	<li class="parent">
		...
		<ul class="dropdown-menu"> 
            ...
            <li class="divider"></li>
            <li>
                <a href="<?php echo $this->url('routeAdmin/default', array('controller' => 'contract', 'action' => 'search'));?>" target="_self">
                    <i class="fa fa-search"></i> <span class="title">Tìm kiếm đơn hàng</span><span class="arrow"></span>
                </a>
            </li>
            <li class="divider"></li>
            <li>
...
<!--					<i class="fa fa-dollar"></i> <span class="title">Danh sách hóa đơn</span><span class="arrow"></span>-->
<!--				</a>-->
<!--			</li>-->
		</ul>
	</li>
...
<!--            <li class="hidden">-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'production', 'action' => 'guarantee'));?><!--" target="_self">-->
<!--                    <i class="fa fa-file-text-o"></i> <span class="title">Đơn hàng bảo hành</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--            <li class="dropdown-submenu">-->
<!--                <a href="javascript:;" target="_self">-->
<!--                    <i class="fa fa-link"></i> <span class="title">Cấu hình giá vốn</span><span class="arrow"></span>-->
<!--                </a>-->
<!--                <ul class="dropdown-menu" style="display: none;">-->
<!--                    <li>-->
<!--                        <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'color-group', 'action' => ''));?><!--" target="_self">-->
<!--                            <i class="fa fa-file-text-o"></i> <span class="title">Nhóm nguyên liệu</span><span class="arrow"></span>-->
<!--                        </a>-->
<!--                    </li>-->
<!--                    <li>-->
<!--                        <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'carpet-color', 'action' => ''));?><!--" target="_self">-->
<!--                            <i class="fa fa-file-text-o"></i> <span class="title">Màu thảm</span><span class="arrow"></span>-->
<!--                        </a>-->
<!--                    </li>-->
<!--                    <li>-->
<!--                        <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'tangled-color', 'action' => ''));?><!--" target="_self">-->
<!--                            <i class="fa fa-file-text-o"></i> <span class="title">Màu rối</span><span class="arrow"></span>-->
<!--                        </a>-->
<!--                    </li>-->
<!--                </ul>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'product-listed', 'action' => 'index'));?><!--">-->
<!--                    <i class="fa fa-product-hunt"></i> <span class="title">Niêm yết sản phẩm</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'capital-default', 'action' => 'index'));?><!--">-->
<!--                    <i class="fa fa-product-hunt"></i> <span class="title">Giá vốn mặc định</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'product', 'action' => 'index'));?><!--">-->
<!--                    <i class="fa fa-product-hunt"></i> <span class="title">Sản phẩm</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'combo-product', 'action' => 'index'));?><!--">-->
<!--                    <i class="fa fa-product-hunt"></i> <span class="title">Combo sản phẩm</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'product-setting', 'action' => 'index'));?><!--">-->
<!--                    <i class="fa fa-product-hunt"></i> <span class="title">Cấu hình sản phẩm</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
		</ul>
	</li>
...
<!--    <li class="parent">-->
<!--        <a href="javascript:;" target="_self" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" class="dropdown-toggle">-->
<!--            <i class="fa fa-cogs"></i> <span class="title">Nhân viên thi công</span><span class="arrow"></span>-->
<!--        </a>-->
<!--        <ul class="dropdown-menu">-->
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'production', 'action' => 'technical-tailors'));?><!--" target="_self">-->
<!--                    <i class="fa fa-wrench"></i> <span class="title">Đơn hàng</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="javascript:;" onclick="javascript:popupAction('/xadmin/evaluate/form/', {'id': '158346528491a52c649j38'});">-->
<!--                    <i class="fa fa-check-square-o"></i> <span class="title">Đánh giá nhân viên</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'evaluate', 'action' => 'index-sales'));?><!--" target="_self">-->
<!--                    <i class="fa fa-bar-chart"></i> <span class="title">Sales</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'evaluate', 'action' => 'index-technical'));?><!--" target="_self">-->
<!--                    <i class="fa fa-bar-chart"></i> <span class="title">Kỹ thuật</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'evaluate', 'action' => 'index-tailors'));?><!--" target="_self">-->
<!--                    <i class="fa fa-bar-chart"></i> <span class="title">Thợ may</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--        </ul>-->
<!--    </li>-->
...
<!--			</li>-->
            ...
            <li class="divider"></li>
<!--            <li>-->
<!--                <a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'material', 'action' => 'index'));?><!--" target="_self">-->
<!--                    <i class="fa fa-hourglass-half"></i> <span class="title">Nhập nguyên liệu đầu kỳ</span><span class="arrow"></span>-->
<!--                </a>-->
<!--            </li>-->
<!--			<li>-->
<!--				<a href="--><?php //echo $this->url('routeAdmin/default', array('controller' => 'contract', 'action' => ''));?><!--" target="_self">-->
<!--					<i class="fa fa-file-text-o"></i> <span class="title">Giá bán</span><span class="arrow"></span>-->
<!--				</a>-->
<!--			</li>-->
		</ul>
	</li>
