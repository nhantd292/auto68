...
class PermissionController extends ActionController {
    ...
    public function formAction() {
        ...
        if(!empty($this->params('id'))) {
            ...
            if(!empty($item)) {
                $item_permission_list_ids = $item['permission_list_ids'];
        ...
        if($this->getRequest()->isPost()){
            ...
            if($myForm->isValid()){
                ...
                if($item_permission_list_ids != implode(',', $permission_list_ids)){
                    $this->getServiceLocator()->get('Admin\Model\UserTable')->saveItem(array('permission_code' => $this->_params['data']['code']), array('task' => 'update-flag'));
                }
