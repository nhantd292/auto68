...
//        $result = $this->kiotviet_call(RETAILER, $this->kiotviet_token, '/webhooks/219526', null, 'DELETE'); // Hủy webhook
...
//        $categories = \ZendX\Functions\CreateArray::create($categories, array('key' => 'categoryId', 'value' => 'categoryName'));
