...
class UserController extends ActionController {
    ...
    public function indexAction() {
        ...
        $this->_viewModel['admin_id']              = $admin_id;
...
//        $myForm			= $this->getForm();
    ...
    public function signoutAction() {
        $result = $this->getTable()->saveItem($this->_params, array('task' => 'signout'));
        $this->flashMessenger()->addMessage('Đăng xuất '.$result.' tài khoản thành công');
        $this->goRoute();
    }
